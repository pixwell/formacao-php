...
<body>
    ...
    <div class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-lg p-6 max-w-sm">
            <img class="w-24 h-24 rounded-full mx-auto mb-4"
                ...
                alt="Profile">
            <h2 class="text-xl font-bold text-center text-gray-800">Dev Fullstack</h2>
            <p class="text-gray-600 text-center mb-4">Reciclando conhecimentos</p>
            <button
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
        <h1 class="text-4xl font-bold text-white">Hello Tailwind CSS v4.1! 🚀</h1>
    </div>
    <?php phpinfo(); ?>
</body>
</html>